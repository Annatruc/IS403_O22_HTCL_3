...
\begin{figure}[H]
  ...
  \begin{minipage}{0.8\linewidth}
    \centering
    \includegraphics[width=1\linewidth]{images/rnn_lt.png}
...
\begin{figure}[H]
  ...
  \begin{minipage}{0.8\linewidth}
    \centering
    \includegraphics[width=1\linewidth]{images/gru_lt.png}
...
\begin{figure}[H]
  ...
  \begin{minipage}{0.8\linewidth}
    \centering
    \includegraphics[width=1\linewidth]{images/lstm_lt.png}
...
\begin{figure}[H]
  ...
  \begin{minipage}{0.8\linewidth}
    \centering
    \includegraphics[width=1\linewidth]{images/random_lt.png}
...
\begin{figure}[H]
  ...
  \begin{minipage}{0.8\linewidth}
    \centering
    \includegraphics[width=1\linewidth]{images/rescnn.png}
    \caption{ResCNN}
    \label{fig8}
  \end{minipage}
\end{figure}
